...
void imagewidget::initimagewidget()
{
    ...
    page=0;
     this->setWindowTitle(tr("Image processing page"));
    ...
    QString titles[] ={tr("Prev-P   "),tr("Next-P "),tr("ZoomIn  "),tr("ZoomOut"),tr("Rotate  "),tr("WaterM"),tr("BlackE"),tr("Check  "),tr("Restore")};
   ...
   label->setFont(qf);
   QString choosetext=tr("P: ")+QString::number(page+1)+QString("/")+QString::number(string_list.size())+"\n";
...
//        jumpPage();
   ...
   help->setFlat(true);
   help->setIcon(QIcon(QCoreApplication::applicationDirPath()+"/icon/help.png"));
   help->setIconSize(QSize(30,30));
   help->setStyleSheet("background-color:transparent;color:rgb(255,255,255)");
   connect(help,&QPushButton::clicked,this,[=]{openhelp();});
   ui->horizontalLayout_3->addWidget(help);
   ui->horizontalLayout_3->setAlignment(help,Qt::AlignLeft);

  shuxing=new QPushButton();

  shuxing->setFont(qf);
  shuxing->setMaximumHeight(30);
  shuxing->setText(tr("about"));
  ...
  shuxing->setIconSize(QSize(30,30));
   ...
   huanyaun->setFont(qf);
   huanyaun->setMaximumHeight(30);
   huanyaun->setText(tr("recovery"));
  ...
  huanyaun->setIconSize(QSize(30,30));
    ...
    shaomiao->setFont(qf);
    shaomiao->setMaximumHeight(30);
    shaomiao->setText(tr("scan"));
...
//    ui->horizontalLayout_3->addWidget(shuxingtext);
    ...
    setPalette(pal);
    QString choosetext2=tr("P: ")+QString::number(page+1)+QString("/")+QString::number(string_list.size())+"\n";
...
void imagewidget::changeUpPage()
{
    ...
    if(imagewidget::page>0&&string_list.size()>0){
        if(page>=0){
            ...
            QString choosetext=tr("P:")+tempcurrpage+QString("/")+QString::number(string_list.size())+"\n";
            label->setText(choosetext);
...
void imagewidget::openshuxing()
{
    ...
    QDialog dialog(this);
    dialog.setWindowTitle(tr("attribute"));
    dialog.setWindowFlags(Qt::FramelessWindowHint);
    dialog.setStyleSheet("background-color:rgba(250,250,250,1);border-radius:20px;padding:15px;");

    dialog.resize(QSize(800,350));

    QFormLayout form(&dialog);
    QFont qf;
    qf.setPixelSize(15);
    // Value1
    QString value1 = QString(tr("file name:"));
   Mylabel *mylabela=new Mylabel();
   mylabela->setText(value1);
   mylabela->setFont(qf);
    ...
    form.addRow(mylabela,  mylabel);


    QString value2 = QString(tr("File address:"));
    Mylabel *mylabel2=new Mylabel();
    Mylabel *mylabelb=new Mylabel();
    mylabelb->setText(value2);
    mylabelb->setFont(qf);
    ...
    form.addRow(mylabelb,  mylabel2);

    QString value3= QString(tr("Resolution ratio:"));
    Mylabel *mylabel3=new Mylabel();
    Mylabel *mylabelc=new Mylabel();
    mylabelc->setText(value3);
    mylabelc->setFont(qf);
    mylabel3->setText(imagesize);
    mylabel3->setMinimumHeight(10);
    mylabel3->setFont(qf);
     mylabel3->setStyleSheet("border:1px solid rgba(0,0,0,0.5);");
    form.addRow(mylabelc,  mylabel3);

    QString value4= QString(tr("Creation time:"));
    Mylabel *mylabeld=new Mylabel();
    mylabeld->setText(value4);
    mylabeld->setFont(qf);
    ...
    form.addRow(mylabeld,  mylabel4);

     QString value5= QString(tr("Modification time:"));
    Mylabel *mylabel5=new Mylabel();
    Mylabel *mylabele=new Mylabel();
    mylabele->setText(value5);
    mylabele->setFont(qf);
...
void imagewidget::openhelp()
{
    ...
    dialog.resize(QSize(800,this->screenheight-50));

    QFormLayout form(&dialog);
    QFont qf;
    qf.setPixelSize(15);
    // Value1
    QString value1 = QString(tr("Prev-P"));
    Mylabel *mylabela=new Mylabel();
    mylabela->setText("Prev-P");
    mylabela->setFont(qf);
    Mylabel *mylabel=new Mylabel();
    mylabel->setText("previous page");
    mylabel->setMinimumHeight(15);
    ...
    QString value2 = QString(tr("Next-P:"));
    Mylabel *mylabel2=new Mylabel();
    Mylabel *mylabelb=new Mylabel();
    mylabelb->setText("Next-P");
    mylabelb->setFont(qf);
    mylabel2->setText("Next Page");
    mylabel2->setMinimumHeight(15);
    mylabel2->setFont(qf);
     mylabel2->setStyleSheet("border:1px solid rgba(0,0,0,0.5);");
    form.addRow(mylabelb,  mylabel2);

    QString value3= QString(tr("Zoom in"));
    Mylabel *mylabel3=new Mylabel();
    Mylabel *mylabelc=new Mylabel();
    mylabelc->setText("Zoom in");
    mylabelc->setFont(qf);
    mylabel3->setText("Zoom in Picture");
    mylabel3->setMinimumHeight(15);
    mylabel3->setFont(qf);
     mylabel3->setStyleSheet("border:1px solid rgba(0,0,0,0.5);");
    form.addRow(mylabelc,  mylabel3);

    QString value4= QString(tr("Zoom out"));
    Mylabel *mylabel4=new Mylabel();
    Mylabel *mylabeld=new Mylabel();
    mylabeld->setText("Zoom out");
    mylabeld->setFont(qf);
    mylabel4->setText("Zoom out Picture");
    mylabel4->setMinimumHeight(15);
    mylabel4->setFont(qf);
     mylabel4->setStyleSheet("border:1px solid rgba(0,0,0,0.5);");
    form.addRow(mylabeld,  mylabel4);

     QString value5= QString(tr("Rotate"));
    Mylabel *mylabel5=new Mylabel();
    Mylabel *mylabele=new Mylabel();
    mylabele->setText("Rotate");
    mylabele->setFont(qf);
    mylabel5->setText("Rotating Picture");
    mylabel5->setMinimumHeight(15);
    mylabel5->setFont(qf);
     mylabel5->setStyleSheet("border:1px solid rgba(0,0,0,0.5);");
    form.addRow(mylabele,  mylabel5);


    QString value6= QString(tr("WaterM"));
   Mylabel *mylabel6=new Mylabel();
   Mylabel *mylabelf=new Mylabel();
   mylabelf->setText("WaterM");
   mylabelf->setFont(qf);
   mylabel6->setText("Add watermark");
   mylabel6->setMinimumHeight(15);
   mylabel6->setFont(qf);
    mylabel6->setStyleSheet("border:1px solid rgba(0,0,0,0.5);");
   form.addRow(mylabelf,  mylabel6);


       QString value7= QString(tr("BlackE"));
      Mylabel *mylabel7=new Mylabel();
      Mylabel *mylabelg=new Mylabel();
      mylabelg->setText("BlackE");
      mylabelg->setFont(qf);
      mylabel7->setText("Remove black edges");
      mylabel7->setMinimumHeight(15);
      mylabel7->setFont(qf);
       mylabel7->setStyleSheet("border:1px solid rgba(0,0,0,0.5);");
      form.addRow(mylabelg,  mylabel7);


      QString value8= QString(tr("Check"));
     Mylabel *mylabel8=new Mylabel();
     Mylabel *mylabelh=new Mylabel();
     mylabelh->setText("Check");
     mylabelh->setFont(qf);
     mylabel8->setText("Correcting images");
     mylabel8->setMinimumHeight(15);
     mylabel8->setFont(qf);
      mylabel8->setStyleSheet("border:1px solid rgba(0,0,0,0.5);");
     form.addRow(mylabelh,  mylabel8);


     QString value9= QString(tr("restore"));
    Mylabel *mylabel9=new Mylabel();
    Mylabel *mylabeli=new Mylabel();
    mylabeli->setText("restore");
    mylabeli->setFont(qf);
    mylabel9->setText("restore the image to its original appearance");
    mylabel9->setMinimumHeight(15);
    mylabel9->setFont(qf);
     mylabel9->setStyleSheet("border:1px solid rgba(0,0,0,0.5);");
    form.addRow(mylabeli,  mylabel9);
...
void imagewidget::openwaterqpb()
{
    ...
    spinbox1->setMinimumHeight(25);



    spinbox1->setFont(qf);
    spinbox1->setStyleSheet("QLineEdit{border:1px solid rgba(0,0,0,0.5);padding:20px;border-radius:20px;margin-top:20px;}");
    form.addRow(qm1, spinbox1);

    QString value2 = QString(tr("Font size:"));
    ...
    QString value4 = QString(tr("Full screen:"));
          ...
          dir.setFilter (QDir::Files | QDir::NoSymLinks); // 设置类型过滤器，只为文件格式
           ...
           int dir_count = dir.count();
            if(dir_count==0){
                ...
                QString choosetext=tr("P: ")+QString::number(1)+QString("/")+QString::number(string_list.size())+"\n";
                label->setText(choosetext);
...
void imagewidget::checkscannfinsh(){
         ...
         if(!qfile.exists()){
             QMessageBox *msgBox=new QMessageBox(QMessageBox::Information, tr("Scan success"), "", QMessageBox::Ok|QMessageBox::Cancel, this);
                msgBox->setText("Scan "+QString::number(readfloadimageint())+" page");
                QFont qf;
                qf.setPixelSize(20);
                msgBox->setFont(qf);
