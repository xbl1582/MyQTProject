#include "applist.h"
#include "QDebug"
APPList::APPList(QList<QWidget *> &list, QWidget *parent) :
...
void APPList::initAnimationGroup()
{
...
/*
   ...
   */
void APPList::singleAnimationShow(int targetIndex, int duration)
{
...
/*
   ...
   *@param:   duration:动画的持续时间(ms)
   */
void APPList::parallelAnimationShow(int curTargetIndex, int nextTargetIndex, ANIMATION_DIRECT direct, bool isTransitioned, int duration)
{
...
void APPList::resizewindow(QSize size)
{
    this->resize(size);
}
/*
   ...
   */
void APPList::setCurrentPage(int index, bool isAnimation)
{
...
/*
   ...
   */
void APPList::setMoveEnabled(bool moveEnabled)
{
...
/*
   ...
   */
void APPList::animationFinished()
{
    if(transitioned)
    {
...
/*
   ...
   *@param:   event:鼠标事件
   */
void APPList::mousePressEvent(QMouseEvent *event)
{
...
/*
   ...
   *@param:   event:鼠标事件
   */
void APPList::mouseReleaseEvent(QMouseEvent *event)
{
...
/*
   ...
   *@param:   event:鼠标事件
   */
void APPList::mouseMoveEvent(QMouseEvent *event)
{
